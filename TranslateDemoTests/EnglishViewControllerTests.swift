//
//  EnglishViewControllerTests.swift
//  TranslateDemo
//
...
class EnglishViewControllerTests: XCTestCase {
    
    func testUpdateTextSpanishInvalid() {
        let mainStoryboard = UIStoryboard(name: "Main", bundle: NSBundle.mainBundle())
        
        if let testSpanishView = mainStoryboard.instantiateViewControllerWithIdentifier("EnglishViewController")  as? EnglishViewController{
